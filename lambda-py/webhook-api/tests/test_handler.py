...
os.environ["TOPIC_ARN_BUILD_REQUEST"] = "arn:aws:sns:" + region + ":" + account + ":build_request"
...
def test_build_request_published():
    ...
    expected_topic_arn = "arn:aws:sns:" + region + ":" + account + ":build_request"
    expected_event = {"url": "https://foo"}
